...
FormProjectManager::FormProjectManager(QWidget *parent)
: QDialog(parent)
...
FormProjectManager::~FormProjectManager()
{
}


void FormProjectManager::selectProject_Slot()
{
...
void FormProjectManager::newProject_Slot()
{
	FormNewProject *npj = new FormNewProject(this);
	npj->exec();
}

void FormProjectManager::addProject_Slot()
{	
...
void FormProjectManager::removeFromList_Slot()
{
...
QStringList FormProjectManager::loadProjects()
{
	QStringList outList;
