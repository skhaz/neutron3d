...
{
    FormProjectManager* pm = new FormProjectManager(this);
    pm->show();
...
{
    FormImageView *img = new FormImageView(this);
    img->exec();
}

 void MainWindow::preferencesSlot()
{	
	FormPreferences* pref = new FormPreferences(this);
	pref->exec();
}
 
void MainWindow::aboutSlot()
{
	FormAbout* abt = new FormAbout(this);
	abt->exec();
}
